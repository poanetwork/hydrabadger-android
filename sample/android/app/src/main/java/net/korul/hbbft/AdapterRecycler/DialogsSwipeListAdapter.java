...
import net.korul.hbbft.Dialogs.DialogClickListener;
...
public class DialogsSwipeListAdapter<DIALOG extends IDialog>
        extends RecyclerSwipeAdapter<DialogsSwipeListAdapter.BaseDialogViewHolder> {
     ...
     */
    public DialogsSwipeListAdapter(ImageLoader imageLoader, DialogClickListener clickListener) {
        this(R.layout.item_custom_swipe_dialog_view_holder, DialogViewHolder.class, imageLoader, clickListener);
    }
     ...
     * @param imageLoader  image loading method
     */
    public DialogsSwipeListAdapter(@LayoutRes int itemLayoutId, ImageLoader imageLoader, DialogClickListener clickListener) {
        this(itemLayoutId, DialogViewHolder.class, imageLoader, clickListener);
    }
     ...
     * @param imageLoader  image loading method
     */
    public DialogsSwipeListAdapter(@LayoutRes int itemLayoutId, Class<? extends BaseDialogViewHolder> holderClass,
                                   ImageLoader imageLoader, DialogClickListener clickListener) {
    ...
    public abstract static class BaseDialogViewHolder<DIALOG extends IDialog>
        ...
        protected void setClickListener(DialogClickListener clickListener) {
            this.clickListener = clickListener;
        }
    ...
    public static class DialogViewHolder<DIALOG extends IDialog> extends BaseDialogViewHolder<DIALOG> {
        ...
        protected ImageView onlineIndicator;
        protected LinearLayout dialog_about;
        protected LinearLayout dialog_remove;
        ...
        public DialogViewHolder(View itemView) {
            ...
            dialog_about = itemView.findViewById(R.id.dialog_about);
            dialog_remove = itemView.findViewById(R.id.dialog_remove);
        }
        ...
        public void onBind(final DIALOG dialog) {
            ...
            if (dialog.getUsers().size() > 1) {
                ...
                User user = new User();
                for (Integer i = 0; i < dialog.getUsers().size(); i++) {
                    if (((User) dialog.getUsers().get(i)).getUid().equals(CoreHBBFT.uniqueID1)) {
                        continue;
                    }
                    user = (User) dialog.getUsers().get(i);
                    break;
                }
                if (user == null)
            ...
            dialog_about.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (clickListener != null) {
                        clickListener.onItemButtonAboutClick(v, (Dialog) dialog);
                    }
                }
            });
            ...
            dialog_remove.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (clickListener != null) {
                        clickListener.onItemButtonRemoeClick(v, (Dialog) dialog);
                    }
                }
            });
