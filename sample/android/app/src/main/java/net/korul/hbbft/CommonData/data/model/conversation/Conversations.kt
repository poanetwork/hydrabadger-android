package net.korul.hbbft.CommonData.data.model.conversation
...
import net.korul.hbbft.CommonData.data.model.databaseModel.DDialog
import net.korul.hbbft.CommonData.data.model.databaseModel.DMessage
import net.korul.hbbft.CommonData.data.model.databaseModel.DUser
import net.korul.hbbft.CommonData.data.model.databaseModel.usersIDsModelList
...
class Conversations {
    companion object {
        ...
        fun getDDialog(dialog: Dialog): DDialog {
            ...
            ddialog.dialogDescr = dialog.dialogDescr
